...
脚本作者：@Sliverkiss
For: https://gist.githubusercontent.com/Sliverkiss/33800a98dcd029ba09f8b6fc6f0f5162/raw/aliyun.js
...
2024.01.19 增加脚本随机休眠，修复由于容量不足导致报错的问题
...
class UserInfo {
    ...
    async uploadFileToAlbums() {
        try {
            ...
            let res = await this.createFile(this.albumId, 'iPhone 13');
                ...
                for (let task of tasks) {
                    switch (task.taskName) {
                        ...
                        case '当周备份照片满20张':
                            ...
                            if (task.status != 'finished') {
                                for (let i = 0; i < 20; i++) {
                                    $.uploadStatus = await this.uploadFileToAlbums();
                                    //相册空间容量不足，跳过任务
